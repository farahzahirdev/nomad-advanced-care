        ...
        <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-16">
          <div className="nm-section-copy lg:sticky lg:top-28 lg:self-start">
            ...
            <p className="text-lead mt-5">
              Clinic-grade mental health treatment with nurse monitoring, physician oversight,
              transparent cost, and a local Seattle team you can reach, at home or in Queen Anne.
            </p>

            <div className="nm-media mt-8 hidden lg:block">
              <Image
                src={IMAGES.whyCare}
                alt="Nurse providing supervised clinical care"
                fill
                quality={90}
                sizes="560px"
